...
import sys
sys.path.append("..")
from optimizer_torch import FiraAdamW, GaLoreAdamW, GaLoreRMSProp, FiraRMSProp  
...
def main(args):
    ...
    if any(word in args.optimizer.lower() for word in ['fira', 'galore']):
        ...
        param_groups = [{'params': regular_params}, 
                        {'params': gradient_projection_params, 'rank': args.rank, 'update_proj_gap': args.update_proj_gap, 'alpha': args.alpha, 'proj_type': args.proj_type}]
